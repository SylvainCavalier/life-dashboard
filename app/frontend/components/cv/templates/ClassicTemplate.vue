<template>
  <div class="cv-root cv-classic" :data-color="accentColor">
    <header class="cv-header cv-header-with-photo">
      ...
      <img v-if="photoDataUrl" :src="photoDataUrl" alt="" class="cv-photo" />
    </header>
    ...
    <section v-if="groupedSkills.length">
    ...
    <section v-if="interests.length">
      ...
      <div v-else class="cv-interests-list">
