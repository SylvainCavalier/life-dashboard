          ...
          <div v-else class="space-y-8">
            ...
            <section>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div v-if="profile.height_cm" class="flex flex-col">
                  <span class="text-xs text-gray-500">Taille</span>
                  <span class="text-sm text-gray-900">{{ profile.height_cm }} cm</span>
                </div>
                <div v-if="profile.weight_kg" class="flex flex-col">
                  <span class="text-xs text-gray-500">Poids</span>
                  <span class="text-sm text-gray-900">
                    {{ Number(profile.weight_kg) }} kg
                    <span v-if="profile.bmi" class="text-gray-500">(IMC {{ profile.bmi }})</span>
                  </span>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model.number="form.height_cm" type="number" min="50" max="250" step="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">Poids (kg)</label>
                  <input v-model.number="form.weight_kg" type="number" min="20" max="300" step="0.1" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                </div>
              </div>
...
const emptyForm = {
  blood_type: '', height_cm: null, weight_kg: null, allergies: '', current_medications: '', medical_history: '',
